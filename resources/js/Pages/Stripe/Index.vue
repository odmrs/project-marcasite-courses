                            ...
                            <div x-show="card">
                                <div class="space-y-4">
                                    ...
                                    <!-- <div>
                                        ...
                                        <input v-model="cardName" id="card-name" class="text-sm text-gray-800 bg-white border rounded leading-5 py-2 px-3 border-gray-200 hover:border-gray-300 focus:border-indigo-300 shadow-sm placeholder-gray-400 focus:ring-0 w-full" type="text" placeholder="Seu nome" />
                                    </div> -->
                                </div>
                                <!-- Form footer -->
                                <div class="mt-6">
