    ...
    <div class="container mx-auto p-6 flex flex-col items-center">
        <div class="w-full max-w-full">
            ...
            <form
                v-if="editing"
                @submit.prevent="
                    form.put(route('courses.update', { course: course.id }), {
            ...
            >
                ...
                <div class="mt-4">
                    ...
                    />
                    <InputError
                        :course_name="form.errors.course_name"
                        class="mt-2"
                    />
                </div>
                <!-- course description  -->
                <div class="mt-4">
                    ...
                    ></textarea>
                    <InputError
                        :course_description="form.errors.course_description"
                        class="mt-2"
                    />
                </div>
                <!-- course price  -->
                <div class="mt-4">
                    ...
                    />
                    <InputError
                        :course_price="form.errors.course_price"
                        class="mt-2"
                    />
                </div>
                <!-- start date  -->
                ...
                <div class="mt-4">
                    ...
                    />
                    <InputError
                        :max_students="form.errors.max_students"
                        class="mt-2"
                    />
                </div>
                <!-- add file  -->
